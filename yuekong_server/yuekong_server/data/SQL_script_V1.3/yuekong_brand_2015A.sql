...
CREATE TABLE `brand` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='brand of famiily equipment';
...
-- Dump completed on 2015-07-29 14:49:35
